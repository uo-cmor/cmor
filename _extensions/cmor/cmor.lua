...
local kBibStyleAuthYr = 'cmor-harv'
local kBibStyleNumber = 'cmor-num'
local kBibStyleNumberName = 'cmor-num-names'
...
return {
  {
    Meta = function(meta)
      ...
      if quarto.doc.cite_method() == 'citeproc' and meta['csl'] == nil then
        meta['csl'] = quarto.utils.resolve_path('bib/cmor-harvard.csl')
      end
